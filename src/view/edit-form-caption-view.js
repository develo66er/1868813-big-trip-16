...
class EditFormCaptionView {
    ...
    #createEditFormCaptionTemplate = () => {
      ...
      if (this.#isAddForm) {
        ...
        dateFrom = this.#point.date_from ? this.#point.date_from.format('DD/MM/YY HH:mm') : '';
        dateTo = this.#point.date_to ? this.#point.date_to.format('DD/MM/YY HH:mm') : '';
        price = `${this.#point.base_price}`;
      }
      ...
      return `
          <div class="event__type-wrapper">
              ...
              <label class="event__type  event__type-btn" 
                  for="event-type-toggle-${this.#isAddForm?'1':'2'}">
              ...
              <input 
                  ...
                  id="event-type-toggle-${this.#isAddForm?'1':'2'}" 
                  type="checkbox">
    ...
    get template() {
      return this.#createEditFormCaptionTemplate();
    }
