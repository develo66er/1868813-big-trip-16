...
import {createOfferItemsTemplate} from './offer-items-view.js';
...
const createEventPointTemplate = (point) => {
  ...
  return `<div
            class="event">
                ...
                ${point.offers && point.offers.offers && point.offers.offers.length>0?createOfferItemsTemplate(point.offers.offers):''}
...
export { createEventPointTemplate };
